...
// Example request
var client = new postmark.Client("ad510890-747d-4f9f-a2d8-3c61d5678d1c");
...
function dispatchWebreportVerification (report, callback) {
	...
	var linktext= "http://" + global.myUrl + "/verifywebreport/" + id.toString();

	var emailData = {
		to: report.userEmail,
		// subject: 'Verify your Report',
		// body: 'Please Click to Verify: http://' + global.myUrl + '/verifywebreport/' + id.toString()
		"TemplateId": 374041,
  	"TemplateModel": {
    "link": linktext
  }
	...
	client.sendEmailWithTemplate(emailData);
	// , function(err) {
	// 	callback(err);
